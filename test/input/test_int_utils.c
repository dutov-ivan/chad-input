...
void test_read_int_valid_input_inclusive(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 1, 0, 10, 0, 1, 1);
  TEST_ASSERT_EQUAL(0, result); // Expect success (0)
...
void test_read_int_out_of_range_high_exclusive(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 1, 0, 9, 0, 0, 1);
...
void test_read_int_out_of_range_low_exclusive(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 1, 0, 10, 1, 1, 0);
  TEST_ASSERT_EQUAL(1,
...
void test_read_int_valid_unrestricted(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 0, 0, 0, 0, 0, 0);
  TEST_ASSERT_EQUAL(0, result);   // Expect success (0)
...
void test_read_int_valid_quiet_mode(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 1, 1, 10, 0, 1, 1);
  TEST_ASSERT_EQUAL(0, result); // Expect success (0)
...
void test_read_int_valid_range_inclusive_min_exclusive_max(void) {
  ...
  int result = read_int(&value, "number", "num", 7, 1, 0, 10, 0, 0, 1);
  TEST_ASSERT_EQUAL(
