...
void test_read_int_and_validate_valid_input() {
  int value;
  simulate_stdin("123\n");
  TEST_ASSERT_EQUAL(SUCCESS, read_int_and_validate(&value, "Test Value", "test", 10, false,
...
void test_read_int_and_validate_out_of_range_high() {
  ...
  TEST_ASSERT_EQUAL(ERROR, read_int_and_validate(&value, "Test Value", "test", 10, false,
                                    INT_MAX, INT_MIN, true, true));
}
...
void test_read_int_and_validate_with_restriction_in_range() {
  int value;
  simulate_stdin("50\n");
  TEST_ASSERT_EQUAL(SUCCESS, read_int_and_validate(&value, "Test Value", "test", 10, true,
                                      100, 0, true, true));
...
void test_read_int_and_validate_with_restriction_out_of_range_high() {
  int value;
  simulate_stdin("101\n");
  TEST_ASSERT_EQUAL(ERROR, read_int_and_validate(&value, "Test Value", "test", 10, true, 100,
                                    0, true, true));
}
...
void test_read_long_int_and_validate_valid_input_unrestricted() {
  ...
  int result = read_long_int_and_validate(&value, "Test Value", "test", 10, false, LONG_MAX,
                             LONG_MIN, true, true);
...
void test_read_long_int_and_validate_valid_input_restricted() {
  ...
  int result = read_long_int_and_validate(&value, "Restricted Value", "restricted", 10, true,
                             200, 100, true, true);
  TEST_ASSERT_EQUAL(SUCCESS, result);
  TEST_ASSERT_EQUAL(123, value);
}
...
void test_read_long_int_and_validate_input_too_long() {
  ...
  int result = read_long_int_and_validate(&value, "Long Input", "long", 10, false, LONG_MAX,
                             LONG_MIN, true, true);
...
void test_read_long_int_and_validate_non_numeric_input() {
  ...
  int result = read_long_int_and_validate(&value, "Non-numeric Input", "non_numeric", 10,
...
void test_read_long_int_and_validate_out_of_bounds() {
  ...
  int result = read_long_int_and_validate(&value, "Out of Bounds", "out_of_bounds", 10,
                             false, LONG_MAX, LONG_MIN, true, true);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read_long_int_and_validate_below_bounds() {
  ...
  int result = read_long_int_and_validate(&value, "Below Bounds", "below_bounds", 10, false,
...
void test_read_long_int_and_validate_exact_boundaries_inclusive() {
  ...
  int result = read_long_int_and_validate(&value, "Inclusive Boundaries", "boundaries", 10,
...
void test_read_long_int_and_validate_exact_boundaries_exclusive() {
  ...
  int result = read_long_int_and_validate(&value, "Exclusive Boundaries", "boundaries", 10,
...
void test_read_long_int_and_validate_invalid_format() {
  ...
  int result = read_long_int_and_validate(&value, "Invalid Format", "invalid", 10, false,
                             LONG_MAX, LONG_MIN, true, true);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read_long_long_int_and_validate_valid_input() {
  ...
  int result = read_long_long_int_and_validate(&value, "Enter a number", "num", 20, true,
...
void test_read_long_long_int_and_validate_value_exclusive_lower() {
  ...
  int result = read_long_long_int_and_validate(&value, "Enter a number", "num", 20, true, 10,
                                  20, false, false);
...
void test_read_float_and_validate_valid_input_within_range(void) {
  ...
  int result = read_float_and_validate(&value, "Test Value", "Test", 10, true, 20.0, 10.0,
                          true, true);
...
void test_read_float_and_validate_invalid_input_overflow(void) {
  ...
  int result = read_float_and_validate(&value, "Test Value", "Test", 10, true, 1000.0, 0.0,
                          true, true);
...
void test_read_float_and_validate_input_below_min_value(void) {
  ...
  int result =
      read_float_and_validate(&value, "Test Value", "Test", 10, true, 10.0, 6.0, true, true);
...
void test_read_float_and_validate_valid_input_with_no_restriction(void) {
  ...
  int result = read_float_and_validate(&value, "Test Value", "Test", 10, false, 20.0, 10.0,
                          true, true);
...
void test_read_float_and_validate_input_precision_warning(void) {
  float value;
...
void test_read_double_and_validate_valid_input_within_unrestricted_range(void) {
  ...
  int result =
      read_double_and_validate(&value, "Число", "Ч", 10, false, 0.0, 0.0, false, false);
  TEST_ASSERT_EQUAL(SUCCESS, result);
...
void test_read_double_and_validate_valid_input_within_restricted_range(void) {
  ...
  int result =
      read_double_and_validate(&value, "Число", "Ч", 10, true, 100.0, 50.0, true, true);
  TEST_ASSERT_EQUAL(SUCCESS, result);
...
void test_read_double_and_validate_imprecise_input(void) {
  double value;
  simulate_stdin("123.45678901234567890\n");  // Exceeds precision
  int result =
      read_double_and_validate(&value, "Число", "Ч", 25, false, 0.0, 0.0, false, false);
  TEST_ASSERT_EQUAL(SUCCESS, result);
...
void test_read_long_double_and_validate_within_range(void) {
  simulate_stdin("123.456\n");
  long double value;
  int result = read_long_double_and_validate(&value, "Positive Number", "Num", 50, true,
...
void test_read_long_double_and_validate_below_min(void) {
  ...
  long double value;
  int result = read_long_double_and_validate(&value, "Test Number", "Num", 50, true, 200.0L,
                                100.0L, true, true);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read_long_double_and_validate_edge_min(void) {
  ...
  long double value;
  int result = read_long_double_and_validate(&value, "Edge Test", "Num", 50, true, 200.0L,
                                100.0L, true, true);
  TEST_ASSERT_EQUAL(SUCCESS, result);
...
void test_read_long_double_and_validate_out_of_range_underflow(void) {
  ...
  long double value;
  int result = read_long_double_and_validate(&value, "Underflow Test", "Num", 50, false, 0,
                                0, false, false);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read_long_double_and_validate_out_of_range_overflow(void) {
  ...
  long double value;
  int result = read_long_double_and_validate(&value, "Overflow Test", "Num", 50, false, 0, 0,
                                false, false);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read_long_double_and_validate_not_a_number(void) {
  simulate_stdin("abcd\n");
  long double value;
  int result = read_long_double_and_validate(&value, "Invalid Input", "Num", 50, false, 0, 0,
                                false, false);
  TEST_ASSERT_EQUAL(ERROR, result);
}

void test_read_long_double_and_validate_truncated_precision(void) {
  simulate_stdin("123.45678901234567890\n");
  long double value;
  int result = read_long_double_and_validate(&value, "Precision Test", "Num", 50, false, 0,
                                0, false, false);
  TEST_ASSERT_EQUAL(SUCCESS, result);
...
void test_read_long_double_and_validate_length_exceeded(void) {
  ...
  long double value;
  int result = read_long_double_and_validate(&value, "Length Test", "Num", 20, false, 0, 0,
                                false, false);
  TEST_ASSERT_EQUAL(ERROR, result);
}
...
void test_read() {
  ...
  RUN_TEST(test_read_long_long_int_and_validate_valid_input_with_inclusive_range);
  ...
  RUN_TEST(test_read_float_and_validate_input_precision_warning);
  ...
  RUN_TEST(test_read_double_and_validate_imprecise_input);
  ...
  RUN_TEST(test_read_long_double_and_validate_truncated_precision);
